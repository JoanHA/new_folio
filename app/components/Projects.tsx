      ...
      <div className="flex flex-col gap-1">
        ...
        <ProjectBlock
          ...
          data={{
            ...
            description: "Innova Tech is an e-commerce created to a tech company. This e-commerce was created with a group using SCRUM which I was the leader and product owner. I created fullstack modules like the Cart, Comments, Contact, About us, Categories, Etc.",
          }}
        ...
        <ProjectBlock
          ...
          data={{
            ...
            subtitle: "Software for the company Innovatech Occidente ",
            description: "This is part of the e-commerce created for the company innovatech, here is where the admin will create, edit, delete and update the products those are shown in the web page. Also the admin is able to ask for new products to their providers and some others features they wanted.",
          }}
